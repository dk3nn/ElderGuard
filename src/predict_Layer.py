...
# Recreate your model and inject learned parameters
...
def predict(text: str) -> dict:
    ...
    # 5) Rule-based score (use ORIGINAL text for URL/phone/email detection)
    rule_prob = rule_based_risk_score(text)

    # 6) Combine scores
    final_score = (ai_prob * 0.7) + (rule_prob * 0.3)
